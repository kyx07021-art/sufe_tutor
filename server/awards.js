...
import { decryptField } from '../src/server/core/crypto.js';
import '../constants.js';

const UIC = globalThis.APP_CONSTANTS.UI;

import { initAwardsTable, dbCreateAward, dbCountAwardsByTeacher, dbGetAwardById, dbGetAwardsByTeacher, dbGetAwardsAdmin, dbDeleteAward, dbSetAwardStatus, AWARDS_MAX, AWARD_STATUS, AWARD_TITLE_MAX, AWARD_ISSUER_MAX, AWARD_DATE_RE } from '../src/server/domains/awards/repo.js';
