...
globalThis.APP_CONSTANTS = {
  ...
  UI: {
    ...
    MODULE_INFO: {
      'my-demands': '这里是你的需求清单。发布家教需求后，教师的试课意向会集中出现在这里，你可以逐条查看并决定同意或拒绝。',
      'browse-teachers': '这里展示平台上的全部教师。可按科目、报价、评分筛选，点开卡片查看老师的资料与评价；遇到满意的老师，可以把你的需求直接发过去。',
      'my-chats': '与匹配成功的师生在线沟通的窗口。支持发送文字、图片和文件，消息约每 4 秒自动刷新，双方的交流都会留档。',
      'my-contracts': '合同管理区。会话里谈妥后，起草合同、双方确认、正式签约都在这条流程里完成；签好的合同具有法律效力。',
      'notifications': '这里汇总平台给你的各类提醒：试课意向、需求推送、合同进展等都会通知到这里。右上角按钮可以一键屏蔽系统广播。',
      'account-settings': '账户与外观设置。可以切换亮色/暗色主题、更换头像、管理登录设备，页面底部提供退出登录与注销账户。',
      'about': '平台介绍页。包含平台理念、基本用法、安全隐私说明，以及给我们反馈 Bug 或建议的通道。',
      'browse-demands': '这里展示学生发布的全部家教需求。可按年级、科目等筛选浏览，看到合适的需求就可以提交试课意向，等学生确认。',
      'resource-share': '教师之间共享教学资源的区域。可以发布图文帖子，也可以浏览和点赞同行分享的资料。',
      'edit-profile': '完善你的个人档案：省份、年级、擅长科目、高考成绩、可授课时间段、性格关键词、报价等。资料越完整，学生越容易信任并选择你。',
      'admin-stats': '平台运行数据总览。展示注册用户、需求、合同等核心指标，方便把握整体情况。',
      'admin-traffic': '站点流量与平均延迟监测。查看访问量与响应时间，及时发现异常波动。',
      'admin-students': '学生账户管理。查看学生列表、处理封禁与解封等账户级操作。',
      'admin-teachers': '教师账户管理。查看教师列表、处理封禁与解封等账户级操作。',
      'admin-demands': '全平台需求管理。查看、删除任意用户发布的需求，维护广场内容秩序。',
      'admin-reviews': '评价审核与删除。用户提交的评价先经过这里审核，违规内容可删除。',
      'admin-posts': '资料帖子管理。查看教师共享的资料帖子，删除不合规内容。',
      'admin-contracts': '合同管理。查看平台全部合同，必要时移除测试数据。',
      'admin-feedback': '用户反馈处理。查看用户提交的 Bug 与建议，逐条标记处理状态。',
    },
