...
export const TEXT = {
  ...
  "BTN_UNBAN": "解封",
  "VERIFY_TEACHER": "认证",
  "VERIFY_TEACHER_CONFIRM": "确认通过该教师的学籍认证吗？",
  "UNVERIFY": "撤认证",
  "UNVERIFY_DONE": "已撤销学籍认证",
  "UNVERIFY_CONFIRM": "确认撤销该教师的学籍认证吗？",
  "ADMIN_USER_SEARCH_PLACEHOLDER": "搜索用户名…",
  ...
  "PAGE_ADMIN_AWARDS_DESC": "审核奖学金申请与凭证",
  "PAGE_ADMIN_VERIFICATIONS": "学信网核验",
  "PAGE_ADMIN_VERIFICATIONS_DESC": "核验教师学籍在线验证报告",
  "ADMIN_VERIF_EMPTY": "没有核验记录",
  "ADMIN_VERIF_FORM_HINT": "去学信网核验页（xlcx.chsi.com.cn 或学信网小程序扫码）查证这个验证码对应的报告，按报告内容填写院校、层次等信息后通过。",
  "ADMIN_VERIF_APPROVE_BTN": "核验通过",
  "ADMIN_VERIF_REJECT_BTN": "拒绝",
  "ADMIN_VERIF_REVOKE_BTN": "撤销核验",
  "ADMIN_VERIF_APPROVE_REQUIRED": "院校与层次为必填项",
  "ADMIN_VERIF_APPROVED_OK": "核验已通过，学籍信息已填入教师档案并通知",
  "ADMIN_VERIF_REJECTED_OK": "已拒绝该核验申请并通知教师",
  "ADMIN_VERIF_REVOKED_OK": "已撤销该教师核验资格并通知",
  "ADMIN_VERIF_ADMISSION_NO_CODE": "录取通知书核验（无验证码）",
  "ADMIN_VERIF_ADMISSION_TAG": "录取通知书",
  "ADMIN_VERIF_ADMISSION_VIEW_IMG": "查看通知书原图",
  "ADMIN_VERIF_SCHOOL_PLACEHOLDER": "如：上海财经大学",
  "ADMIN_VERIF_LEVEL_PLACEHOLDER": "本科 / 硕士",
  "ADMIN_VERIF_MAJOR_PLACEHOLDER": "如：金融学",
  "ADMIN_VERIF_STATUS_PLACEHOLDER": "在籍 / 已毕业",
  "ADMIN_VERIF_YEAR_PLACEHOLDER": "如 2024",
  "ADMIN_VERIF_APPROVE_CONFIRM": "确认通过该教师学籍核验并录入学籍信息吗？",
  "ADMIN_VERIF_REJECT_CONFIRM": "确认拒绝该核验申请吗？拒绝后教师可重新提交。",
  "ADMIN_VERIF_REVOKE_CONFIRM": "确认撤销该教师的核验资格吗？撤销后接单资格关闭，教师可重新提交。",
  "ADMIN_VERIF_REASON_LABEL": "驳回理由（可选）",
  "ADMIN_VERIF_REASON_PLACEHOLDER": "将通知教师",
  "ADMIN_VERIF_SCHOOL_LABEL": "院校",
  "ADMIN_VERIF_LEVEL_LABEL": "层次",
  "ADMIN_VERIF_MAJOR_LABEL": "专业",
  "ADMIN_VERIF_STATUS_LABEL": "在读状态",
  "ADMIN_VERIF_YEAR_LABEL": "入学年份",
  "ADMIN_VERIF_NOT_FOUND": "没有找到该核验记录",
  ...
  "MODULE_INFO": {
    ...
    "admin-verifications": "## 这是什么\n教师学籍认证核验队列。\n\n## 怎么用\n查看教师提交的学信网在线验证码与录取通知书，人工核对院校、层次、专业与在读状态；通过后开放该教师接单资格。\n\n**处理：** 核对无误点「通过」，存疑可「拒绝」并附理由，教师端会收到结果通知。\n\n## 小贴士\n核验前先对照学信网原始报告；对需要补料的教师说明缺哪一项，便于其重新提交。"
  },
