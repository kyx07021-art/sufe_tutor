...
export const TEXT = {
  ...
  "CHAT_STATUS_CLOSED": "已结束",
  "CHAT_END_RELATION": "结束关系",
  "CHAT_END_RELATION_TITLE": "结束关系",
  "CHAT_END_RELATION_CONFIRM": "结束关系后：\n· 本会话将关闭，双方无法再发送消息\n· 进行中的签约请求将自动取消\n· 未完成的合同将自动撤销，已签署合同与存证记录保留留档\n确定结束这段关系吗？",
  "CHAT_END_RELATION_DONE": "已结束关系，会话已关闭",
  "CHAT_END_RELATION_ALREADY": "该关系已结束",
  "CHAT_CONV_CLOSED_MSG": "该会话已结束，无法进行此操作",
