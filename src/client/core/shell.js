  ...
  app.innerHTML = `
    ...
    <div class="client-shell hidden" id="view-client">
      ...
      <main class="client-main" id="client-main">
        ...
        ${page('admin-content', TEXT.PAGE_ADMIN_CONTENT, { body: `<div class="seg-tabs glass glass--solid" id="admin-content-tabs"></div><div class="browse-list" id="admin-content-list"></div>` })}
