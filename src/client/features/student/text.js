...
export const TEXT = {
  ...
  BTN_ACCEPT_INTENT: '提交试课意向',
  DEMAND_DELETED_TOAST: '需求已删除',
  DEMAND_EMPTY: '还没有学生发布需求。教师可以先完善档案，新需求会按匹配度推荐给你。',
  DEMAND_MODAL_TITLE: '提交学生需求',
  DEMAND_SUBMITTED_TOAST: '需求已提交！',
  INTENT_RESOLVED_TOAST: '已同意，可在「我的会话」中开始对话',
  LABEL_SCORES: '各科当前大概成绩',
  LABEL_SUBJECTS: '目标科目',
  PAGE_BROWSE_DEMANDS: '需求大厅',
  PAGE_BROWSE_DEMANDS_DESC: '浏览学生需求并提交意向',
  PAGE_MY_DEMANDS: '我的需求',
  PAGE_MY_DEMANDS_DESC: '发布与管理家教需求',
  PUSH_COOLDOWN_UNIT: '已发送',
  PUSH_SUBMITTED_TOAST: '需求已发送',
  VALIDATE_DEMAND_INCOMPLETE: '请选择学生年级',
};
