/** 服务端错误码/文案与结构化通知类型（V-1-1 过渡形态：仍回中文 msg）。零依赖，纯数据。 */
export const MSG = {
  ...
  PERSONALITY_TAGS_TOO_MANY: "性格关键词最多选 3 个",
  ...
  GREETING_TOO_LONG: "打招呼消息太长（上限 300 字）",
  ...
  COMPLAINT_ATTACH_TOO_MANY: "投诉附件最多 4 个",
